...
const i18n = {
  en: {
    ...
    /* Card 1 — Berline Economy */
    'vc1-name':'Berline Economy',
    'vc1-cap':'<strong>1 to 4 passengers</strong> · 2 large bags + 1 small',
    ...
    'vc1-cta':'Book Berline Economy',
    /* Card 2 — Premium */
    'vc2-name':'Berline Luxe',
    'vc2-cap':'<strong>1 to 4 passengers</strong> · 3 bags max',
  ...
  fr: {
    ...
    'vc1-name':'Berline Economy',
    'vc1-cap':'<strong>1 à 4 passagers</strong> · 2 gros bagages + 1 petit',
    ...
    'vc1-cta':'Réserver en Berline Economy',
    'vc2-name':'Berline Luxe',
    'vc2-cap':'<strong>1 à 4 passagers</strong> · 3 bagages max',
